<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mobile.aspx.cs" Inherits="SitesDesktopMobilesResponsives.site1.forms.Mobile" %>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Coffe-Desktop</title>

<%--    <link href="../css/Desktop.css?Version=2" rel="stylesheet" media="max-device-width:850px"/>--%>
    <link href="../css/Mobile.css?version=4" rel="stylesheet" />
    <meta charset="utf-8"/>
      ...
      <asp:DataList ID="DataList1" runat="server" RepeatColumns="1" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" CssClass="datalistitem" EnableTheming="True" HorizontalAlign="Center" DataSourceID="SqlDataSource1">
        ...
        <section class="home" id="home">
            <div class="content">
                ...
                <p> benefícios exclusivos do café baseados em evidências nutricionais O café faz mais do que aumentar sua energia. A
                     algumas xícaras diárias de café também podem reduzir o risco de diabetes tipo 2 </p>
        ...
        <section class="menu" id="menu">
             <h1 class="heading"> Nosso <span> Menu</span> us</h1>
              ...
              <asp:Panel ID="Panel2" class="box" HorizontalAlign="center" ScrollBars="Both" runat="server">
                  <asp:DataList ID="DataList2" ForeColor="antiquewhite" runat="server" DataSourceID="SqlDataSource3" CssClass="DataList2"  GridLines="Both" DataKeyField="coffecup_id" HorizontalAlign="Center">
                    <AlternatingItemStyle BackColor="#13131a" />
                <FooterStyle BackColor="#CCCCCC" ForeColor="Black" />
                <HeaderStyle BackColor="#000084" Font-Bold="True" ForeColor="White" />
                <ItemStyle BackColor="#13131a" ForeColor="antiquewhite" CssClass="DataList2item" />
                      <ItemTemplate>
                          <br />
                    <table>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <h2 id="coffecup_id" runat="server" class="h3">Item no carrinho:<%# Eval("coffecup_id") %></h2>
                                <asp:Label ID="Label2" runat="server" ForeColor="AntiqueWhite" Text='<%# Eval("coffecup_id") %>'></asp:Label>
                                <p class="h3">
                                    O melhor que você pode tomar de manhã</p>
                                <br />
                                <asp:Label ID="Label1" runat="server" ForeColor="AntiqueWhite" Text='<%# Eval("coffecup_name") %>'></asp:Label>
                            </td>
                            <tr>
                                <td>
                                    <asp:Button ID="Button1" runat="server" CommandArgument='<%# Eval("coffecup_id") %>' CommandName="Cart" CssClass="btn-geral" Text="Button" />
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                        </tr>
